...
class Flash_OfficeEquip extends StatefulWidget {
  const Flash_OfficeEquip({Key key}) : super(key: key);

  @override
  _Flash_OfficeEquipState createState() => _Flash_OfficeEquipState();
}
...
final List data = [
  {
    ...
    'word': "Ruler",
    'picture': "assets/Office/1.png",
    'meaning': "ไม้บรรทัด",
    'example': "A ruler helps one to draw a straight line."
  },
  {
    'color': Colors.orange.shade200,
    'word': "Scissors",
    'picture': "assets/Office/2.png",
    'meaning': "กรรไกร",
    'example': "I cut the paper with a pair of scissors."
  },
  {
    'color': Colors.yellow.shade200,
    'word': "Calculator",
    'picture': "assets/Office/3.png",
    'meaning': "เครื่องคิดเลข",
    'example': "The calculator is a wonderful invention."
  },
  {
    'color': Colors.green.shade200,
    'word': "Stapler",
    'picture': "assets/Office/4.png",
    'meaning': "ที่เย็บกระดาษ",
    'example': "A stapler is very useful for attaching papers together."
  },
  {
    'color': Colors.blue.shade200,
    'word': "Pen",
    'picture': "assets/Office/5.png",
    'meaning': "ปากกา",
    'example': "I use my pen to write on the paper."
  },
  {
    'color': Colors.grey.shade200,
    'word': "Pencil",
    'picture': "assets/Office/6.png",
    'meaning': "ดินสอ",
    'example': "A pencil is sticking out of my pocket."
  },
  {
    'color': Colors.grey.shade400,
    'word': "Eraser",
    'picture': "assets/Office/7.png",
    'meaning': "ยางลบ",
    'example': "Rub out these words with your eraser."
  },
];
...
class _Flash_OfficeEquipState extends State<Flash_OfficeEquip> {
    ...
    child: ElevatedButton.icon(
      ...
      onPressed: () {
        Navigator.pushReplacement(
            context,
            MaterialPageRoute(
                builder: (BuildContext context) => Flash_OfficeEquip()));
      },
    ),
  );
}
