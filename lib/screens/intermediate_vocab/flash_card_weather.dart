...
class Flash_Weather extends StatefulWidget {
  const Flash_Weather({Key key}) : super(key: key);

  @override
  _Flash_WeatherState createState() => _Flash_WeatherState();
}
...
final List data = [
  {
    ...
    'word': "Sunny",
    'picture': "assets/Weather/1.png",
    'meaning': "มีแสงแดดมาก",
    'example': "sunny day is ideal for a picnic."
  },
  {
    'color': Colors.orange.shade200,
    'word': "Cloudy",
    'picture': "assets/Weather/2.png",
    'meaning': "ปกคลุมด้วยเมฆ",
    'example': "Today is cloudy."
  },
  {
    'color': Colors.yellow.shade200,
    'word': "Fog",
    'picture': "assets/Weather/3.png",
    'meaning': "หมอก",
    'example': "A thick fog delayed our flight."
  },
  {
    'color': Colors.green.shade200,
    'word': "Rain",
    'picture': "assets/Weather/4.png",
    'meaning': "ฝน",
    'example': "A bicycle will rust if you leave it in the rain."
  },
  {
    'color': Colors.blue.shade200,
    'word': "Snow",
    'picture': "assets/Weather/5.png",
    'meaning': "ปกคลุมด้วยหิม",
    'example': "It will snow tomorrow."
  },
  {
    'color': Colors.grey.shade200,
    'word': "Windy",
    'picture': "assets/Weather/6.png",
    'meaning': "มีลมแรง",
...
class _Flash_WeatherState extends State<Flash_Weather> {
    ...
    child: ElevatedButton.icon(
      ...
      onPressed: () {
        Navigator.pushReplacement(
            context,
            MaterialPageRoute(
                builder: (BuildContext context) => Flash_Weather()));
      },
    ),
  );
}
