...
class Flash_Workshop extends StatefulWidget {
  const Flash_Workshop({Key key}) : super(key: key);

  @override
  _Flash_WorkshopState createState() => _Flash_WorkshopState();
}
...
final List data = [
  {
    ...
    'word': "Hacksaw",
    'picture': "assets/Workshop/1.png",
    'meaning': "เลื่อยตัดโลหะ",
    'example': "I have hacksaw in the trunk of my car."
  },
  {
    'color': Colors.orange.shade200,
    'word': "Hand drill",
    'picture': "assets/Workshop/2.png",
    'meaning': "สว่านมือ",
    'example': "Hand drill is a very good tool."
  },
  {
    'color': Colors.yellow.shade200,
    'word': "Wood",
    'picture': "assets/Workshop/3.png",
    'meaning': "ไม้",
    'example': "Birds were singing in the woods."
  },
  {
    'color': Colors.green.shade200,
    'word': "Ladder",
    'picture': "assets/Workshop/4.png",
    'meaning': "บันได",
    'example': "He placed the ladder against the fence."
  },
  {
    'color': Colors.blue.shade200,
    'word': "Shovel",
    'picture': "assets/Workshop/5.png",
    'meaning': "พลั่ว",
    'example': "They were buying shovels."
  },
  {
    'color': Colors.grey.shade200,
    'word': "Toolbox",
    'picture': "assets/Workshop/6.png",
    'meaning': "กล่องเครื่องมือ",
    'example': "He's getting the toolbox in his office."
  },
];
...
class _Flash_WorkshopState extends State<Flash_Workshop> {
    ...
    child: ElevatedButton.icon(
      ...
      onPressed: () {
        Navigator.pushReplacement(
            context,
            MaterialPageRoute(
                builder: (BuildContext context) => Flash_Workshop()));
      },
    ),
  );
}
