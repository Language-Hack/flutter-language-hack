...
class Flash_Toelf extends StatefulWidget {
  const Flash_Toelf({Key key}) : super(key: key);

  @override
  _Flash_ToelfState createState() => _Flash_ToelfState();
}
...
final List data = [
  {
    ...
    'word': "Assignment",
    'picture': "assets/TOEFL/1.png",
    'meaning': "งาน,การมอบหมาย",
    'example': "I have a lot of assignments to do today."
  },
  {
    'color': Colors.orange.shade200,
    'word': "Attendance",
    'picture': "assets/TOEFL/2.png",
    'meaning': "การเข้างาน,การเข้าชั้นเรียน",
    'example': "Regular attendance is required in class."
  },
  {
    'color': Colors.yellow.shade200,
    'word': "Cheat",
    'picture': "assets/TOEFL/3.png",
    'meaning': "การคดโกง",
    'example': "He cheated on the biology exam."
  },
  {
    'color': Colors.green.shade200,
    'word': "Enroll",
    'picture': "assets/TOEFL/4.png",
    'meaning': "ลงทะเบียน, สมัคร",
    'example': "He enroll the course in the college."
  },
  {
    'color': Colors.blue.shade200,
    'word': "Essay",
    'picture': "assets/TOEFL/5.png",
    'meaning': "บทความ, เรียงความ",
    'example': "All essays must be handed in on time."
  },
  {
    'color': Colors.grey.shade200,
    'word': "Exam",
    'picture': "assets/TOEFL/6.png",
    'meaning': "การสอบ",
...
class _Flash_ToelfState extends State<Flash_Toelf> {
    ...
    child: ElevatedButton.icon(
      ...
      onPressed: () {
        Navigator.pushReplacement(
            context,
            MaterialPageRoute(
                builder: (BuildContext context) => Flash_Toelf()));
      },
    ),
  );
}
