...
final List data = [
  ...
  },
  {
    ...
    'meaning': "อึกทึก,เสียงดัง,หนวกหู",
    ...
    child: ElevatedButton.icon(
      ...
      onPressed: () {
        Navigator.pushReplacement(
            context,
            MaterialPageRoute(
                builder: (BuildContext context) => Flash_Adjectives()));
      },
    ),
  );
}
