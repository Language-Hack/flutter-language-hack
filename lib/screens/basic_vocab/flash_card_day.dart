    ...
    child: ElevatedButton.icon(
      ...
      onPressed: () {
        Navigator.pushReplacement(context,
            MaterialPageRoute(builder: (BuildContext context) => Flash_Days()));
      },
    ),
  );
}
